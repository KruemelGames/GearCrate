...
# Legacy static value (used as reference for 25 rows)
SCROLL_PIXELS_UP = 322  # Reference: scroll distance for ~25 rows
...
# Formula: scroll_distance = travel_space × (rows_per_block / invisible_rows) × correction_factor
# Calculated from: 322px / 266px (base) = 1.21
...
# When enabled: No OCR scanning, just moves mouse through grid and scrolls
# Shows estimated rows at start, item count at end
